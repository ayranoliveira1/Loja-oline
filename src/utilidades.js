...
export function desenharProdutoCarrinhoSimples(idProduto,idConteinerHtml, quantidadeProduto) {
  const produto = catalogo.find(p => p.id === idProduto);

  const conteinerProdutosCarrinhos = document.getElementById(idConteinerHtml);
